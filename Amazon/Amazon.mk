...
WorkspacePath          := "C:\Users\celio\Documents\PROGRAMACAO II"
...
Objects0=$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/SiteDeVendas.cpp$(ObjectSuffix) $(IntermediateDirectory)/Amazon.cpp$(ObjectSuffix) $(IntermediateDirectory)/Data.cpp$(ObjectSuffix) $(IntermediateDirectory)/Site.cpp$(ObjectSuffix) $(IntermediateDirectory)/RedeSocial.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/Site.cpp$(ObjectSuffix): Site.cpp $(IntermediateDirectory)/Site.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/celio/git/Amazon/Amazon/Site.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Site.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Site.cpp$(DependSuffix): Site.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Site.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Site.cpp$(DependSuffix) -MM "Site.cpp"

$(IntermediateDirectory)/Site.cpp$(PreprocessSuffix): Site.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Site.cpp$(PreprocessSuffix) "Site.cpp"

$(IntermediateDirectory)/RedeSocial.cpp$(ObjectSuffix): RedeSocial.cpp $(IntermediateDirectory)/RedeSocial.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/celio/git/Amazon/Amazon/RedeSocial.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/RedeSocial.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/RedeSocial.cpp$(DependSuffix): RedeSocial.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/RedeSocial.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/RedeSocial.cpp$(DependSuffix) -MM "RedeSocial.cpp"

$(IntermediateDirectory)/RedeSocial.cpp$(PreprocessSuffix): RedeSocial.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/RedeSocial.cpp$(PreprocessSuffix) "RedeSocial.cpp"
